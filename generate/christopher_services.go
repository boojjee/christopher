...
func Gen_table(c *gin.Context) {
	...
	if name == "" {
		...
		var merchant_meta_table = `CREATE TABLE ` + mmerchant_metachant + ` (
                        ...
                        merchant_category BIGINT(20) DEFAULT NULL, 
                        merchant_province VARCHAR(255) DEFAULT NULL, 
		...
		var offer_meta_table = `CREATE TABLE ` + offer_meta + ` (
                ...
                value double(100,5) DEFAULT NULL,
		...
		var offer_table = `CREATE TABLE ` + offer + ` (
                ...
                condition_offer LONGTEXT DEFAULT NULL, 
		...
		var point_table = `CREATE TABLE ` + point + ` (
                id BIGINT(20) unsigned NOT NULL AUTO_INCREMENT,
                point_uid VARCHAR(200) DEFAULT NULL,
		...
		// Point Blance
		var pointBlance = prefix + "_" + "point_balance"
		var pointBlance_table = `CREATE TABLE ` + pointBlance + ` (
                id BIGINT(20) unsigned NOT NULL AUTO_INCREMENT, 
                user_uid VARCHAR(200) DEFAULT NULL,  
                blance_point double(100,5) DEFAULT NULL, 
                create_at BIGINT(20) NULL DEFAULT NULL,
                update_at BIGINT(20) NULL DEFAULT NULL,
                PRIMARY KEY (id)
                ) ENGINE=InnoDB DEFAULT CHARSET=utf8;`

		result_pointBlance, err := DB.Exec(pointBlance_table)
		log.Println(result_pointBlance)
		checkErr(err)
		//------------------------------------------------------

		// Point Setting
		var pointSetting = prefix + "_" + "setting_point"
		var pointSetting_table = `CREATE TABLE ` + pointSetting + ` (
                id BIGINT(20) unsigned NOT NULL AUTO_INCREMENT, 
                point_type VARCHAR(200) DEFAULT NULL,  
                constant_point double(100,5) DEFAULT NULL, 
		...
		result_pointSetting_table, err := DB.Exec(pointSetting_table)
		log.Println(result_pointSetting_table)
		checkErr(err)
		//------------------------------------------------------
		...
		var redeem_table = `CREATE TABLE ` + redeem + ` (
                id BIGINT(20) unsigned NOT NULL AUTO_INCREMENT,
                redeem_uid VARCHAR(100) DEFAULT NULL,                
                offer_uid VARCHAR(100) DEFAULT NULL,
		...
		// log_location
		var log_location = prefix + "_" + "user"
		var log_location_table = `CREATE TABLE ` + log_location + ` (  
                id BIGINT(20) unsigned NOT NULL AUTO_INCREMENT,
                user_uid VARCHAR(100) DEFAULT NULL,
                mylocation_lat double(100,5) DEFAULT NULL, 
                mylocation_lon double(100,5) DEFAULT NULL, 
                province VARCHAR(100) DEFAULT NULL,
                tag_log VARCHAR(100) DEFAULT NULL,
                create_at BIGINT(20) NULL DEFAULT NULL,
                update_at BIGINT(20) NULL DEFAULT NULL,
                PRIMARY KEY (id)
                ) ENGINE=InnoDB DEFAULT CHARSET=utf8;`
		result_log_location, err := DB.Exec(log_location_table)
		log.Println(result_log_location)
