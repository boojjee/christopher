...
func (m *MerchantMeta) MerchantShowInfoAllLang(service_name string) (string, string, error) {
	...
	mm := MerchantMeta{
		...
		m_meta_content_en.Address_en, m_meta_content_th.Address_th, m_meta.Phone_1, m_meta.Phone_2, m_meta.Fax, m_meta.Line_id, m_meta.Facebook_link, m_meta.Website_link,
